...
import com.Raj.repository.CartRepository;
import com.Raj.repository.CouponRepository;
...
public class CouponServiceImpl implements CouponService {
    ...
    public Cart applyCoupon(String code, double orderValue, User user) throws Exception {
        ...
        if (coupon.isActive() &&
            ...
            double discount = (cart.getTotalSellingPrice() * coupon.getDiscountPercentage()) / 100;
        ...
        throw new Exception("Coupon not active or not within validity period");
    }
